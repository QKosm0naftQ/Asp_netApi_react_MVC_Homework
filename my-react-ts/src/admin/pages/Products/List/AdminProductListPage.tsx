...
import { Popconfirm, message } from "antd"; // імпортуємо компоненти
import { useDeleteProductMutation } from "../../../../services/apiProducts"; // твій хук
                    ...
                    <TableRow key={product.id}>
                      ...
                      <TableCell className="py-3 text-gray-500 dark:text-gray-400">
                        <div className="flex space-x-4">
                          ...
                          {/* Обгортаємо Remove у Popconfirm */}
                          <Popconfirm
                          ...
                          >
                            <div className="flex items-center cursor-pointer text-red-600 hover:text-red-800 transition-colors duration-200">
